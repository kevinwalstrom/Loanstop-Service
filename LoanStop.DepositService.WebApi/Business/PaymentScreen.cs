...
namespace LoanStop.Services.WebApi.Business
{
    public class PaymentScreen
    {
        ...
        /// <summary> ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// 
        public PaymentScreen(string connectionString)
        {
        ...
        public object GetTransactionAndPayments(long transId)
        {
            ...
            var payments = paymentRepository.GetAllForTransaction(transId);
            ...
            var Item = new
            {
                ...
                finalDueDate = trans.PaymentPlanChecks.Count > 0 ?  trans.PaymentPlanChecks[5].DateDue : DateTime.Now.Date  ,
        ...
        /// <summary> ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// 
        public int UpdatePaymentTransaction(
            string ssNumber,
            long transId,
            decimal amount,
            decimal balance,
            ...
            decimal otherFees,
            bool bReceivedCash,
            bool bChangeClientStatusToPaid
        )
        {
            var rtrn = 0;
        ...
        public void SetTransactionStatus(long transId, string status)
        {
            var transactionRepository = new LoanStop.DBCore.Repository.Transaction(connectionString);
