...
/******/ 	var hotCurrentHash = "17e8044789a3652c6d18"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Application = __webpack_require__(158);

	var _Application2 = _interopRequireDefault(_Application);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Application2.default, null), document.getElementById('app-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLogger = __webpack_require__(188);
	...
	function configureStore(initialState) {
	  ...
	  if (true) {
	    module.hot.accept(189, function () {
	      return store.replaceReducer(__webpack_require__(189) /*.default if you use Babel 6+ */);
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRedux.connect)(selector)(Application);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExecutionEnvironment = __webpack_require__(204);

	var _DOMUtils = __webpack_require__(205);

	var _DOMStateStorage = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Page = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactInlineCss = __webpack_require__(254);
	...
	var Page = _react2.default.createClass({
	  displayName: 'Page',
	  isPreferencesOpen: function isPreferencesOpen() {
	    return this.props.location.pathname == '/preferences';
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      _reactInlineCss2.default,
	      { stylesheet: _styles2.default, componentName: 'component' },
	      _react2.default.createElement(
	        'div',
	        null,
	        this.props.children
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scores = __webpack_require__(258);

	var _scores2 = _interopRequireDefault(_scores);

	var _ColoradoYearly = __webpack_require__(259);

	var _ColoradoYearly2 = _interopRequireDefault(_ColoradoYearly);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ColoradoYearly2.default, _scores2.default)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	//var url = 'http://localhost:15525/api/report/colorado/statesummary/';
	var url = 'http://stage.loanstop.com:8080/api/report/colorado/statesummary/';

	exports.default = _react2.default.createClass({
			displayName: 'ColoradoYearly',


			gedivefaultProps: function gedivefaultProps() {
					return {
							numberOfWeeks: 8,
							update: [],
							leagueKey: null
			...
			handleSelect: function handleSelect(event) {
					...
					$.getJSON(url + event.target.value + '/2015', function (store) {
							$("#spinner").hide();

							var response = store.Item;

							console.log(response);

							_self.displayData(response);
					});
			},
			componentWillMount: function componentWillMount() {
					...
					$("#spinner").show();
					$.getJSON(url + this.state.store + '/2015', function (store) {
			...
			displayData: function displayData(data) {
					...
					// question 1
					document.querySelector('#oneCount').innerHTML = data.totalsLoans.count;
					document.querySelector('#oneSum').innerHTML = data.totalsLoans.sum;

					// question 2
					document.querySelector('#twoACount').innerHTML = data.byAmount[0].count;
					document.querySelector('#twoASum').innerHTML = data.byAmount[0].amount;
					document.querySelector('#twoBCount').innerHTML = data.byAmount[1].count;
					document.querySelector('#twoBSum').innerHTML = data.byAmount[1].amount;

					// question 3 Rescinded
					document.querySelector('#threeCount').innerHTML = data.loansOutstanding[0].count;
					document.querySelector('#threeSum').innerHTML = data.loansOutstanding[0].amount;

					// question 4
					document.querySelector('#fourCount').innerHTML = data.rescinded.count;
					document.querySelector('#fourSum').innerHTML = data.rescinded.amount;

					// question 5

					// question 6
					if (data.activeMilitary) {
							document.querySelector('#sixCount').innerHTML = data.activeMilitary.count;
							document.querySelector('#sixSum').innerHTML = data.activeMilitary.amount;
					}

					// question 7
					document.querySelector('#sevenCount').innerHTML = data.defaulted.count;
					document.querySelector('#sevenSum').innerHTML = data.defaulted.amount;

					document.querySelector('#sevenASum').innerHTML = data.amountRecovered.amountPaid;
					document.querySelector('#sevenBSum').innerHTML = data.amountchargeOffs.amountRecieved;
					document.querySelector('#sevenCSum').innerHTML = data.nsfFees.amountPaid;

					// question 8
					document.querySelector('#eightCount').innerHTML = data.bySSNumber.total;
					document.querySelector('#eightACount').innerHTML = data.bySSNumber.a;
					document.querySelector('#eightBCount').innerHTML = data.bySSNumber.b;
					document.querySelector('#eightCCount').innerHTML = data.bySSNumber.c;

					// question 9
					document.querySelector('#nineACount').innerHTML = data.question9.question9partA.a.financeCharge.toFixed(2);
					document.querySelector('#nineASum').innerHTML = data.question9.question9partA.a.amount.toFixed(2);
					document.querySelector('#nineAiCount').innerHTML = data.question9.question9partA.i.financeCharge.toFixed(2);
					document.querySelector('#nineAiiCount').innerHTML = data.question9.question9partA.ii.financeCharge.toFixed(2);
					document.querySelector('#nineAiiiCount').innerHTML = data.question9.question9partA.iii.financeCharge.toFixed(2);

					document.querySelector('#nineBCount').innerHTML = data.question9.question9partB.a.financeCharge.toFixed(2);
					document.querySelector('#nineBSum').innerHTML = data.question9.question9partB.a.amount.toFixed(2);
					document.querySelector('#nineBiCount').innerHTML = data.question9.question9partB.i.financeCharge.toFixed(2);
					document.querySelector('#nineBiiCount').innerHTML = data.question9.question9partB.ii.financeCharge.toFixed(2);
					document.querySelector('#nineBiiiCount').innerHTML = data.question9.question9partB.iii.financeCharge.toFixed(2);

					document.querySelector('#nineCCount').innerHTML = data.question9.question9partC.a.financeCharge.toFixed(2);
					document.querySelector('#nineCSum').innerHTML = data.question9.question9partC.a.amount.toFixed(2);
					document.querySelector('#nineCiCount').innerHTML = data.question9.question9partC.i.financeCharge.toFixed(2);
					document.querySelector('#nineCiiCount').innerHTML = data.question9.question9partC.ii.financeCharge.toFixed(2);
					document.querySelector('#nineCiiiCount').innerHTML = data.question9.question9partC.iii.financeCharge.toFixed(2);

					document.querySelector('#nineD').innerHTML = data.question9.question9partD.averageAPR.toFixed(2);
					document.querySelector('#nineE').innerHTML = data.question9.question9partE.averageAPR.toFixed(2);
					document.querySelector('#nineF').innerHTML = data.question9.question9partF;
					document.querySelector('#nineG').innerHTML = data.question9.question9partG.toFixed(2);
					document.querySelector('#nineH').innerHTML = data.question9.question9partH;

					document.querySelector('#ten').innerHTML = data.question10.total;
					document.querySelector('#tenA').innerHTML = data.question10.partA;
					document.querySelector('#tenB').innerHTML = data.question10.partB;
					document.querySelector('#tenC').innerHTML = data.question10.partC;
					document.querySelector('#tenD').innerHTML = data.question10.partD;
					document.querySelector('#tenE').innerHTML = data.question10.partE;
					document.querySelector('#tenF').innerHTML = data.question10.partF;
			},
			render: function render() {
					...
					return _react2.default.createElement(
							...
							_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'oneCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'oneSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'twoACount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'twoASum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'twoBCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'twoBSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'threeCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'threeSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1', id: 'fourCount' },
													'-----'
											),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1', id: 'fourSum' },
													'-----'
											)
									),
									_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sixCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sixSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sevenCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sevenSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sevenASum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sevenBSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'sevenCSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'eightCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'eightACount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'eightBCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'eightCCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineACount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineASum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineAiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineAiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineAiiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineBCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineBSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineBiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineBiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineBiiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineCCount' }),
											_react2.default.createElement(
													'div',
													{ className: 'col-sm-1' },
													'$'
											),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineCSum' })
									),
									_react2.default.createElement(
											'div',
											{ className: 'row' },
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineCiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineCiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineCiiiCount' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineD' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineE' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineF' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineG' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'nineH' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-6' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'ten' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenA' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenB' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenC' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenD' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenE' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									),
									_react2.default.createElement(
											...
											_react2.default.createElement('div', { className: 'col-sm-1', id: 'tenF' }),
											_react2.default.createElement('div', { className: 'col-sm-1' }),
											_react2.default.createElement('div', { className: 'col-sm-1', id: '' })
									)
							)
